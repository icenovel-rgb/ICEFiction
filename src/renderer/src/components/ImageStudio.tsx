 ...
 *
 * 표지에서 제목을 앱이 얹는 이유(실측):
 *  ① 프롬프트에 "book cover/title"이 있으면 모델이 가짜 영문 제목을 그려 넣는다.
 *  ② 모델은 한글을 제대로 못 쓴다.
        ...
        <div className="studio-body">
          <div className="studio-left">
            ...
            <span className="insp-hint">
              AI는 <b>글자 없는 그림</b>만 그립니다 — 모델이 한글을 못 쓰고, 표지라고 말하면 엉터리
              글자를 그려 넣기 때문입니다. {isCover && '제목은 아래에서 앱이 얹습니다.'}
            </span>
